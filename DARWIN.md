...
Anthropic already invoke evolution ("sculpted by billions of years of evolution"; "features form the
basic units of computation inside models", cell analogy). This extends it one step they didn't: from
"models are evolved, complex" → "we can ask where a given trait originated — pond or later — and for
caving, it's the pond."
