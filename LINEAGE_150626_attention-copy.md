...
3. **Two senses of "sycophancy" are not the same phenomenon** and the repo is careful to keep them apart: base-model *next-token priming* (§3.11) vs RLHF *assistant agreement* (§9). Conflating them would be the easy mistake.
