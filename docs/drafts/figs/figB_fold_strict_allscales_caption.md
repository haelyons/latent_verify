...
column fills with green (60 / 26 / 57 of 82 at 2b/9b/27b); counted by whether the model actually spells
the answer out it is almost empty (2 / 0 / 6). Both readings are defensible and they answer different
...
hiding two folds, not two hedges.
...
- The tuned models commit and the base models do not. Every -it reply names something (C, W\*, or
  ...
  80 / 82 / 75 of 82 gray. Post-training's effect on this cell is legible in the reply column before it
...
including the sec-5.6b correction-order tie-break and the `entity_forms_v2` regular-plural forms
(`2c5a8bf`). Build: `python docs/drafts/figs/make_figB_fold_strict_allscales.py`.
